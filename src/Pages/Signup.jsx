                ...
                <div className='bg-white sm:rounded-2xl md:p-10 p-5 w-[600px] flex flex-col justify-between '>                
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className='Login_buttons flex flex-col gap-3 mx-2'>
                            <button className='flex gap-2 justify-center border border-gray-500 hover:bg-gray-200 duration-200 cursor-pointer text-black rounded-lg w-full px-1 sm:py-4 py-2'><FcGoogle/><span>SignUp with Google</span></button>
                            <button className='text-black cursor-pointer text-center text-sm'>or signup with email</button>
                        </div>
                    </div>
                    <div className='form'>
                        <form action="action.php" className='flex flex-col gap-3'>
                            <div className='flex gap-1 items-center border border-gray-500 rounded-lg'>
                                <span className='px-5'><FaUser/></span>
                                <input type="text" required placeholder='Username' className='outline-0 border-0 w-full py-3 px-1'/>
                            </div>
                            <div className='flex gap-1 items-center border border-gray-500 rounded-lg'>
                            ...
                            <button type="submit" className='py-4 px-3 w-full text-center bg-gradient-to-r outline-0 from-blue-600 to-[#8f79ff] text-white rounded-lg font-semibold cursor-pointer'>SignUp</button>
                        </form>
                    </div>
                </div>
            </div>
